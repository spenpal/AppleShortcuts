...
Welcome to my Apple Shortcuts repo! This repo represents a comprehensive list and details of all Apple shortcuts I've built till date. Feel free to peruse — you might end up finding something useful!

To download my shortcuts, just click on the banner on the **README** file within each shortcut folder. You can also find my shortcuts published on [RoutineHub](https://routinehub.co/user/spenpal), which is my official Shortcuts page.
